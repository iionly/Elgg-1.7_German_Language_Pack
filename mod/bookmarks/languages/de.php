<?php
	...
	$german = array(
		 ...
		 */
			...
			'bookmarks:read' => "Lesezeichen von %s",
			...
			'bookmarks:shared' => "Lesezeichen",
			'bookmarks:visit' => "Gehe zu dem Eintrag",
			'bookmarks:recent' => "Die neuesten Lesezeichen",

			'bookmarks:river:created' => '%s hat ein Lesezeichen gesetzt: ',
			...
			'groups:enablebookmarks' => 'Gruppen-Lesezeichen aktivieren',
		 ...
		 */
			...
			'bookmarks:widget:description' =>
					"Dieses Widget zeigt Deine neuesten Lesezeichen an.",
		 ...
		 */
			...
			'bookmarks:save:failed' => "Das Lesezeichen konnte nicht gespeichert werden. Bitte gebe einen Titel und eine Adresse an und versuche es noch einmal.",
