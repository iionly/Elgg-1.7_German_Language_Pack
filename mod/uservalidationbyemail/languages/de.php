...
",
	...
	'email:validate:success:subject' => "Email-Adresse bestätigt %s!",
	'email:validate:success:body' => "Hallo %s,

Gratuliere, Deine Email-Adresse wurde erfolgreich bestätigt.",
	...
	'uservalidationbyemail:admin:unvalidated' => 'Inaktive Benutzeraccounts',
